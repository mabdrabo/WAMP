...
//		frmWhereAreMy.setBounds(0, 0, 600, 600);
	...
	public void SearchButton(SearchStrategy strategy) {
		...
		lblCost.setText("Cost " + ((returnList == null)? "No Solution" : (Integer) returnList[1]));
		lblexpansions.setText("#Expansions " + ((returnList == null)? "No Solution" : (Integer) returnList[2]));
